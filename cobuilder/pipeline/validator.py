...
Validation Rules (from schema.md section 11):
    ...
    12. Full cluster topology check: every codergen node must have downstream wait.cobuilder and wait.human nodes
    13. wait.human nodes must follow wait.cobuilder or research nodes
"""
