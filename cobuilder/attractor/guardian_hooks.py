...
from cobuilder.attractor.runner_models import RunnerPlan, RunnerState
...
_STALE_THRESHOLD_SECONDS: int = int(
    os.environ.get("ATTRACTOR_GUARDIAN_STALE_SECONDS", "300")
)
...
class RunnerGuardian:
    ...
    Args:
        ...
        stale_threshold_seconds: Seconds since last update before a runner
            ...
            ``ATTRACTOR_GUARDIAN_STALE_SECONDS`` env var or 300.
