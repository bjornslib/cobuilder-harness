...
from cobuilder.attractor.checkpoint import save_checkpoint  # noqa: E402
from cobuilder.attractor.parser import parse_file, parse_dot  # noqa: E402
from cobuilder.attractor.transition import apply_transition, VALID_TRANSITIONS  # noqa: E402
...
class PipelineRunner:
    ...
    def _handle_human(self, node: dict, data: dict) -> None:
        ...
        try:
            from cobuilder.attractor.gchat_adapter import send_review_request  # type: ignore[import]
            send_review_request(
                node_id=nid,
                pipeline_id=self.pipeline_id,
...
Examples:
  ...
  # Check imports work:
  python3 -c "from cobuilder.attractor.pipeline_runner import PipelineRunner; print('Import OK')"
        """,
    )
    ap.add_argument(
        "--dot-file",
