...
def main() -> None:
    ...
    if command == "parse":
        from cobuilder.engine.dispatch_parser import main as parser_main
        parser_main()
    elif command == "validate":
        from cobuilder.engine.validator import main as validator_main
        validator_main()
    elif command == "status":
        from cobuilder.engine.status import main as status_main
        status_main()
    elif command == "transition":
        from cobuilder.engine.transition import main as transition_main
        transition_main()
    elif command == "checkpoint":
        from cobuilder.engine.dispatch_checkpoint import main as checkpoint_main
        checkpoint_main()
    elif command == "generate":
        from cobuilder.engine.generate import main as generate_main
        generate_main()
    elif command == "annotate":
        from cobuilder.engine.annotate import main as annotate_main
        annotate_main()
    elif command in ("init-promise", "init_promise"):
        from cobuilder.engine.init_promise import main as init_promise_main
        init_promise_main()
    elif command == "dashboard":
        from cobuilder.engine.dashboard import main as dashboard_main
        dashboard_main()
    elif command == "node":
        from cobuilder.engine.node_ops import main as node_ops_main
        node_ops_main()
    elif command == "edge":
        from cobuilder.engine.edge_ops import main as edge_ops_main
        edge_ops_main()
    elif command == "lint":
        ...
        from cobuilder.engine.agents_cmd import main as agents_main
        agents_main()
    elif command in ("merge-queue", "merge_queue"):
        from cobuilder.engine.merge_queue_cmd import main as merge_queue_main
        merge_queue_main()
    else:
