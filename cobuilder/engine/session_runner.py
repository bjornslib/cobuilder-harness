...
DEFAULT_MODEL = "claude-sonnet-4-6"  # default Claude model for runner
...
import cobuilder.engine.signal_protocol as signal_protocol
...
def build_worker_system_prompt(
    ...
    with logfire.span("runner.build_worker_system_prompt", node_id=node_id, prd_ref=prd_ref):
        return (
            ...
            f"- Write a signal file to $PIPELINE_SIGNAL_DIR/{node_id}.json on completion\n"
...
class RunnerStateMachine:
    ...
    def __init__(
        ...
        """
        import cobuilder.engine.signal_protocol as _sp
