...
generate_summary_section() {
    local security_status="${1:-✅ Pass}"
    local security_issues="${2:-0}"
    local code_quality_status="${3:-✅ Pass}"
    local code_quality_issues="${4:-0}"
    local documentation_status="${5:-✅ Pass}"
    local documentation_issues="${6:-0}"
    local lifecycle_status="${7:-✅ Pass}"
...
finalize_report() {
    local report_file="$1"
    local security_status="${2:-✅ Pass}"
    local security_issues="${3:-0}"
    local code_quality_status="${4:-✅ Pass}"
    local code_quality_issues="${5:-0}"
    local documentation_status="${6:-✅ Pass}"
    local documentation_issues="${7:-0}"
    local lifecycle_status="${8:-✅ Pass}"
    ...
    update_report_section "$report_file" "📊 Summary" "$summary"
...
show_summary() {
    ...
    sed -n '/^## 📊 Summary/,/^## /p' "$report_file" | head -n -1
}
